package com.example.cleancodefileupload.security;

import com.example.cleancodefileupload.entity.Role;
...
public class JwtTokenProvider {
   ...
   protected  void init(){
    ...
    //Tokenning srogi tugagan yoki borligini bildirish uchun
